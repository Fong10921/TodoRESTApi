...
namespace TodoRESTApi.Entities.Migrations
{
    ...
    [Migration("20250331014642_AddMetaRole")]
    partial class AddMetaRole
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TodoRESTApi.identity.Identity.ApplicationRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("TodoRESTApi.identity.Identity.MetaRole", b =>
                {
                    ...
                    b.Property<string>("RoleClaimsId")
                        .HasColumnType("TEXT")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("TodoRESTApi.identity.Identity.MetaRole", null)
                        .WithMany("RoleClaims")
                        .HasForeignKey("MetaRoleId");

                    b.HasOne("TodoRESTApi.identity.Identity.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("TodoRESTApi.identity.Identity.ApplicationUser", null)
                        .WithMany()
